...
function addPurpleSquareButton() {
    ...
    likeButtons.forEach(likeButton => {
        if ((likeButton === null || likeButton === void 0 ? void 0 : likeButton.parentElement) === null) {
            return;
        }
        if (likeButton.parentElement.querySelector('.sbjkt-button')) {
            return;
        } //Already added.
        // Generate button.
        ...
        // Insert.
        likeButton === null || likeButton === void 0 ? void 0 : likeButton.parentElement.appendChild(purpleButton);
    });
}
// Observer
